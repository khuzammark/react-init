...
import {
  ...
  CreateGoogleAdsFinalUrlReportDataSourceMutation
} from "queries/data.gql";

class GoogleAdsFinalUrlReportStep2 extends React.Component {
  state = { accountId: "", accountName: "" };

  onChange = field => e => this.setState({ [field]: e.target.value });

  createGoogleAdsFinalUrlReport = async () => {
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <Grid item xs={3}>
          <FormControl fullWidth className={classes.selectFormControl}>
            <Button color="google" onClick={this.createGoogleAdsFinalUrlReport}>
              Submit
            </Button>
          </FormControl>
        </Grid>
...
GoogleAdsFinalUrlReportStep2.propTypes = {
...
export default withStyles(extendedFormsStyle)(
  compose(graphql(CreateGoogleAdsFinalUrlReportDataSourceMutation))(
    withLoader(GoogleAdsFinalUrlReportStep2, "linear")
  )
);
