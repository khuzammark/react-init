...
// core components
import HeaderLinks from "components/Header/HeaderLinks/HeaderLinks.jsx";
...
class SidebarWrapper extends React.Component {
  ...
  render() {
    // TODO: removed user here because it's a mock
    const { className, headerLinks, links } = this.props;
    return (
      <div className={className} ref={this.sidebarRef}>
        {/*user*/}
        {headerLinks}
        {links}
      </div>
  ...
  render() {
    ...
    var brand = (
      <div className={logoClasses}>
        <a href="https://codingisforlosers.com/" className={logoMini}>
          <img src={logo} alt="logo" className={classes.img} />
        </a>
        <a href="https://codingisforlosers.com/" className={logoNormal}>
          {logoText}
        </a>
      </div>
    );
