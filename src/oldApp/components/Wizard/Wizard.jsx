...
export class Wizard extends React.Component {
  ...
  refreshAnimation(index) {
    ...
    var move_distance =
      this.wizardRef.current.children[0].offsetWidth / total_steps;
    ...
    if (mobile_device) {
      move_distance = this.wizardRef.current.children[0].offsetWidth / 2;
      index_temp = index % 2;
      li_width = 50;
    }
              ...
              return (
                <div className={stepContentClasses} key={key}>
                  <prop.stepComponent
                    ...
                    injectState={this.injectState(key)}
                  />
                </div>
              );
            })}
