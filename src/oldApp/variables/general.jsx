...
const stories = [
  {
    ...
    inverted: true,
    badgeColor: "warning",
    badgeIcon: LocalDining,
    title: "Prep the Ingredients",
    titleColor: "warning",
    body: (
      <div>
        <p>
          Connect 3rd-party APIs like Google Analytics, in order to fetch data
          and write it to your BigQuery data warehouse.
        </p>
        <p>
          Note: API keys to paid services like SEMrush may be included gratis in
          your plan.
        </p>
        <p>
          {`If you're creating your own data analysis recipes, you'll also need to
          connect your GitHub account to point us to your repo of SQL models.`}
        </p>
      </div>
    ),
    footerTitle: "Sift and measure both the wet and dry ingredients."
  },
  {
    // Second story
    badgeColor: "info",
    ...
    body: (
      <div>
        <p>
          Pipe data from all of the 3rd-party APIs required for your recipe into
          your BigQuery warehouse.
        </p>
        <p>
          {`
          Once the raw ingredients are all assembled, we'll run SQL models
          (written in `}
          <a href="https://getdbt.com">dbt</a>
          {`to transform your
          raw data into glorious insights.
          `}
        </p>
      </div>
    ),
    footerTitle: "A massive chemical change will take place in the oven."
  },
  {
    // Third story
    inverted: true,
    badgeColor: "success",
    badgeIcon: Fastfood,
    title: "Let's Eat!  Nom nom nom.",
    titleColor: "success",
    body: (
      <div>
        <p>
          Your data analysis cake is baked, and the answers to all of your
          questions are in your BigQuery warehouse, waiting to be eaten.
        </p>
        <p>
          {`You'll be able to visualize your data any way you like: in our native
          dashobard, from the BigQuery console, or in a BI tool like Tableau or
          Google Data Studio.
          `}
        </p>
      </div>
    ...
    footerTitle:
      "Eat your meal wherever you like - after all, it belongs to you."
  }
];
